...
/************************射频发送数据状态判断************************/
LoRapp_Handle_t LoRapp_Handle = {false, false,false, false, false, false, 0, 0, 0, 0, NULL, 0, 0, 0, 0, CAD, RFWRITE};
...
/*
*UserSetLoRaMac：设置CLASS模式，同时分配内存
*参数：					 无
*返回值：				 无
*/
